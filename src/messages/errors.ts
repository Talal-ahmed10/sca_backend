const ENGLISH = {
  ...
  updateOnly:
    "You can only updates those fields first_name, last_name, avatar, notification, gender, weight, height and fat",
  not_found: "Not found",
...
export const GERMAN = {
  ...
  updateOnly:
    "Sie können nur die Felder Vorname, Nachname, Avatar, Benachrichtigung, Geschlecht, Gewicht, Größe und Fett aktualisieren",
...
export const ERRORS = LANGUAGE === "german" ? ENGLISH:GERMAN ;

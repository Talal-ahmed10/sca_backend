...
exports.emailVerificationTemplate = exports.otpEmailTemplate = void 0;
...
const otpEmailTemplate = (otp, name) => {
  ...
  <body>
    ...
    <div class="textCenter mb30">
        <a href="${app_constants_1.WEB_BASE_URL}" target="_blank">
          <img
            src="${app_constants_1.LOGO_URI}"
            alt="logo"
            width="143px"
            height="auto"
            class="mb20"
      ...
      <p  class="mb20">
        Thank you for choosing ${app_constants_1.APP_NAME}. Use the following OTP to complete
...
const emailVerificationTemplate = (email, password, first_name) => {
    return `
  <html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <div class="textCenter mb50">
      ...
      <p>Regards</p>
      <p>${app_constants_1.APP_NAME} Team</p>
      </p>
     <i>
     ${notProdEnv() ? `This is from ${process.env.NODE_ENV} environment` : ''}
     </i>
